...
本題要求以 C++ 類別 Polynomial 表示一元多項式，並實作多項式的 輸入、輸出 / 加法、減法、乘法 / 拷貝建構、指定運算子 / 解構子（並回收節點）/ Evaluate(x) 計算值。
...
本作業成功以循環鏈結串列實作多項式之完整功能，並結合排序插入與節點回收機制，正確完成多項式的表示與運算。整體設計符合題目規範，並在效率與記憶體管理方面達到良好平衡。
